...
class PowerShellRunner:
    ...
    def run_command(self, command, timeout = None, valid_exit_codes = [0], encoding= None, force_utf8 = True, to_json = False, json_depth = 2, sanitize_json = True, **kwargs):
        """
        ...
        command = self.powershell_interpreter + ' -NonInteractive -NoLogo {}{}{}'.format(utf8_prefix, command, to_json_suffix)
    ...
    def run_script(self, script, *args, timeout = None, valid_exit_codes = [0], encoding= None, **kwargs):
        """
        Accepts subprocess.check_output arguments
        """
