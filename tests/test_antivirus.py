...
def test_securitycenter_get_product_type():
    assert securitycenter_get_product_type(
        AV_DISABLED_AND_UP_TO_DATE) == 'Antivirus', 'Product type should be antivirus'
    assert securitycenter_get_product_type(AV_ENABLED_AND_UP_TO_DATE) == 'Antivirus', 'Product type should be antivirus'
    assert securitycenter_get_product_type(FW_ENABLED) == 'Firewall', 'Product type should be firewall'
    assert securitycenter_get_product_type(FW_DISABLED) == 'Firewall', 'Product type should be firewall'
    try:
...
def test_securitycenter_get_product_exec_state():
    assert securitycenter_get_product_exec_state(
        AV_DISABLED_AND_UP_TO_DATE) is False, 'Product state should be disabled'
    assert securitycenter_get_product_exec_state(AV_ENABLED_AND_UP_TO_DATE) is True, 'Product state should be enabled'
    assert securitycenter_get_product_exec_state(FW_ENABLED) is True, 'Product state should be enabled'
    assert securitycenter_get_product_exec_state(FW_DISABLED) is False, 'Product state should be disabled'


def test_securitycenter_get_product_update_state():
    assert securitycenter_get_product_update_state(
        AV_DISABLED_AND_UP_TO_DATE) is True, 'Product state should be uptodate'
    assert securitycenter_get_product_update_state(
        AV_ENABLED_AND_UP_TO_DATE) is True, 'Product state should be uptodate'
