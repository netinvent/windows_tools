...
def test_get_installed_software():
    ...
    command = r'reg add HKLM\Software\Microsoft\Windows\CurrentVersion\Uninstall\Test_windows_tools.installed_software' \
    ...
    assert isinstance(result[0], dict), 'get_installed_software() should return list of dict'
